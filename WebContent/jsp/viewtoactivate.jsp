...
<h1><font color=""><center> Showing Details Of Required Customer</center></font></h1>
<table  class="CSSTableGenerator">
				<tr><td>FirstName</td><td><input type="text" value=" <%=customer.getFirstname()%>" disabled="disabled"></td></tr>
					...
					<tr><td colspan="2"><a
							href="<%=request.getContextPath()%>/UserController?source=activated&&email=<%=customer.getEmail()%>"><center><input type="button" id="shiny" value="Activate" onclick="return validateActivation()" ></center></input></a></td>
