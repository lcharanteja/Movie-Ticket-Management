...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      ...
      <li>&#187;</li>
      <li><a href="#">Activated Success</a></li>
      </ul>
  </div>
</div>
...
<div class="wrapper col3">
  <div id="gallery2">
<h1 style="color: green" align="center"> &#10004;  You have Successfully Activated Customer Account with Emailid= <%= request.getAttribute("id")  %> </h1>
