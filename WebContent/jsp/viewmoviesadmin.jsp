...
<div class="wrapper col3">
  <div id="gallery">
  <h6 style="color: #336666; font-size: 18px"> Click on the movie poster to operate on movie and know more </h6>
<%
...
<td width="300px" style="text-align: center; padding: 40px"><h4 align="left" style="color:#336666; text-align: center; sans-serif; font-style: italic">movie id: <%= mb.getMovieId() %> </h4> <br> <h1 style="text-align: center; color: black "><%= mb.getName().toUpperCase() %></h1> <td>
