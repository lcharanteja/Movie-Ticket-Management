...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      ...
      <li>&#187;</li>
      <li><a href="<%= request.getContextPath() %>/MovieController?source=upcomingmovieadmin">Up Coming Movies</a></li>	
    </ul>
  </div>
</div>
...
<td width="300px" style="text-align: center; padding: 40px"><h4 align="left" style="color:#336666; margin-top:70px ;text-align: center; sans-serif; font-style: italic">movie id: <%= mb.getMovieId() %> </h4> <br> <h1 style="text-align: center; color: black "><%= mb.getName().toUpperCase() %></h1> <td>
