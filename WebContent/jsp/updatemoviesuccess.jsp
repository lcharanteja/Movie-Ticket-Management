...
if(mb!= null){%>
<h1 align="center" style="color: green"><b><u> &#10004; Hurray!!!"<%=mb.getName() %>" </u> movie details are updated successfully</b> </h1>
...
<input style="margin-left: 630px" align="middle" id="shiny" type="submit" name="home" value="view movies">
</form>
<%} else{%>
