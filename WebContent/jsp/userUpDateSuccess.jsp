...
<div class="wrapper col3">
  <div id="gallery2">
  <h1 ><center></center></h1>
  <h3 style="color:green ; text-align: center;"><center><b>&#10004;You have successfully updated your profile</b></center></h3>
  <p><a href="<%= request.getContextPath() %>/UserController?source=myprofile"><center><input type="button" value="MyProfile" id="shiny"></center></a>
  </p>
    </div>
</div>
