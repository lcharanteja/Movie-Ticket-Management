...
<h1 style="color: #336666; text-align: center;">Emailid or password is incorrect please give correct details..</h1>
<div style="text-align: center;">
<form action="<%= request.getContextPath() %>/UserController?source=login">
<input type="hidden" name="source" value="login"> 
<input type="submit" value="Try again to login" id="shiny">
</form>
</div>
