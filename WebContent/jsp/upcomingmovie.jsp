...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      ...
      <li>&#187;</li>
      <li><a href="<%= request.getContextPath() %>/MovieController?source=upcomingmovie">UpComing Movies</a></li>	
    </ul>
  </div>
</div>
...
<td style="width:200px ;border-width: 0px;"><h1 align="center" style="border-width:0px ;color:#336666; text-align: center; font-family:sans-serif; font-style: italic; margin-top: 60px">Name: <%= mb.getName().toUpperCase() %> </h1><p style="text-align: center; color: black"><%= mb.getLanguage().toUpperCase() %>
<br><input style="margin-top: 100px" id="shiny" type="submit" value="Book Ticket"></p>
<input type="hidden" name="source" value="login"></td>
</table>
</form>
<%}} else{%>
<h3 style="text-align: center; color: #336666;" align="center" ><b>Sorry!!! There are no results found for your request</b></h3>
<form action="<%=request.getContextPath() %>/MultiplexController">
