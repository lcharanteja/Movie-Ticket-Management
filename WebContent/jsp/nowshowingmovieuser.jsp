...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      ...
      <li>&#187;</li>
      <li><a href="<%= request.getContextPath() %>/MovieController?source=nowshowingmovieuser">Now Showing Movies</a></li>	
    </ul>
  </div>
</div>
...
<a href="<%=request.getContextPath() %>/MovieController?source=viewmoviebyidloggedin&id=<%= mb.getMovieId()%>"><img width="250px" height="280px" src="<%= request.getContextPath() %>/ImageController?source=image&&id=<%= mb.getMovieId() %>" ></a>
</td>
<td style="width:200px ;border-width: 0px;"><h1 align="center" style="border-width:0px ;color:#336666; text-align: center; font-family:sans-serif; font-style: italic; margin-top: 60px">Name: <%= mb.getName().toUpperCase() %> </h1> <p style="text-align: center; color: black;font-size: 15px"><%= mb.getLanguage().toUpperCase() %><br> 
<input align="middle" style=" margin-top: 100px"  id="shiny" type="submit"value="book ticket"></p></td></table>
