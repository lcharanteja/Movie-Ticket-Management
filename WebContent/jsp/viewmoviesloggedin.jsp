...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      ...
      <li>&#187;</li>
      <li><a href="<%= request.getContextPath() %>/MovieController?source=viewmoviesloggedin">View Movies</a></li>	
    </ul>
  </div>
</div>
...
<br><input align="middle" style="text-align: center;" id="shiny" type="submit"value="book ticket"></td></table>
<%} %>
</form>
  </div>
</div>
